  ...
  return (
    <section className="relative overflow-hidden pt-8 pb-12 md:pt-14 md:pb-16">
      ...
      <div className="absolute inset-0 pointer-events-none -z-10 overflow-hidden">
        <div className="absolute top-0 right-10 w-[500px] h-[500px] bg-primary/10 rounded-full blur-[120px]" />
        <div className="absolute bottom-0 left-10 w-[500px] h-[500px] bg-amber-500/10 rounded-full blur-[120px]" />
        <div
        ...
        <div className="flex flex-col lg:flex-row items-center justify-between gap-8 lg:gap-12">
          ...
          <div className="flex-1 flex flex-col items-center lg:items-start text-center lg:text-left space-y-6">
            ...
            <motion.div
              ...
              className="w-full max-w-xl bg-card/70 dark:bg-card/50 backdrop-blur-md border border-border/80 rounded-2xl p-3 sm:p-5 shadow-lg"
            >
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 divide-y sm:divide-y-0 sm:divide-x divide-border/60">
                <div className="flex flex-col items-center lg:items-start p-1.5 sm:px-3">
                  <span className="text-[11px] uppercase tracking-wider text-muted-foreground font-semibold mb-0.5">
                    Department
                  </span>
            ...
            >
              <Link href="/profile">
                <Button className="rounded-xl px-5 py-4.5 bg-gradient-to-r from-amber-500 to-primary hover:from-amber-600 hover:to-primary/90 text-white font-semibold shadow-md shadow-amber-500/20 transition-all cursor-pointer text-sm">
                  <Trophy className="w-4 h-4 mr-2" />
                  View Alumni Profile & History
                </Button>
              </Link>
              <Link href="/study-spaces">
                <Button variant="outline" className="rounded-xl px-5 py-4.5 border-border/80 hover:bg-muted font-semibold transition-all cursor-pointer text-sm">
          ...
          {/* Right Column: Prominent 3D Graduated Mascot Avatar */}
          <motion.div
            initial={{ opacity: 0, scale: 0.92 }}
            animate={{ opacity: 1, scale: 1 }}
            transition={{ duration: 0.6, ease: [0.16, 1, 0.3, 1] }}
            className="w-full lg:w-[360px] xl:w-[400px] flex-shrink-0 flex items-center justify-center select-none"
          >
            <div className="relative w-[260px] h-[260px] sm:w-[320px] sm:h-[320px] lg:w-[360px] lg:h-[360px] flex items-center justify-center">
              ...
              <div className="absolute inset-0 bg-gradient-to-tr from-amber-500/20 via-primary/20 to-purple-500/20 rounded-full blur-[50px] scale-90" />
              ...
              <Image
                ...
                width={360}
                height={360}
                className="w-full h-full object-contain drop-shadow-[0_12px_32px_rgba(0,0,0,0.22)] select-none transition-transform hover:scale-105 duration-300"
                priority
              />
            </div>
          </motion.div>
