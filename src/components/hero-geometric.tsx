    ...
    >
      ...
      <div className="relative z-10 container mx-auto px-4 md:px-6">
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            <h1 className="text-[clamp(3.15rem,11vw,7.5rem)] font-bold mb-6 md:mb-8 tracking-tight leading-tight">
              ...
              <br />
              <span className="relative inline-block mt-2.5 md:mt-4 px-5 sm:px-6 md:px-10 py-2 sm:py-2 md:py-4 max-w-full whitespace-nowrap">
