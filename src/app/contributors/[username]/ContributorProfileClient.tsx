    ...
    <div className="space-y-8">
      ...
      <Card className="rounded-3xl border-2 border-border bg-card p-6 sm:p-8 shadow-xl relative overflow-hidden">
        <div className="relative z-10 flex flex-col sm:flex-row items-center sm:items-start gap-6 text-center sm:text-left">
          <Avatar className="w-24 h-24 sm:w-28 sm:h-28 border-4 border-primary shadow-xl">
          ...
          <div className="space-y-3 flex-1">
            ...
            <div className="flex flex-wrap items-center justify-center sm:justify-start gap-3 pt-2">
              ...
              <div className="px-3.5 py-1.5 rounded-2xl bg-primary/10 border border-primary/25 flex items-center gap-2 text-xs font-bold text-primary">
