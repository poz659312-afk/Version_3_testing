...
export const DEPARTMENT_PROGRAM_ELECTIVES: Record<string, Omit<ElectiveSubject, 'departmentKey' | 'category'>[]> = {
  "computing-data-sciences": [
    {
      ...
      creditHours: 3,
      prerequisites: ["Linear Algebra","Numerical Computations","Advanced Calculus"],
      materials: {
    ...
    },
    {
      ...
      creditHours: 3,
      prerequisites: ["Linear Algebra","Data Structures and Algorithms"],
      materials: {
    ...
    },
    {
      ...
      creditHours: 3,
      prerequisites: ["Probability and Statistics II"],
      materials: {
  ...
  "business-analytics": [
    ...
    },
    {
      ...
      creditHours: 3,
      prerequisites: ["Data Mining and Analytics"],
      materials: {
    ...
    },
    {
      ...
      creditHours: 3,
      prerequisites: ["Data and IT Governance"],
      materials: {
    ...
    },
    {
      ...
      creditHours: 3,
      prerequisites: ["Data Mining and Analytics","Financial Planning and Analysis"],
      materials: {
  ...
  "artificial-intelligence": [
    ...
    },
    {
      ...
      creditHours: 3,
      prerequisites: ["Machine Learning","Embedded Systems"],
      materials: {
    ...
    },
    {
      ...
      creditHours: 3,
      prerequisites: ["Internet of Things I"],
      materials: {
  ...
  "cybersecurity": [
    ...
    },
    {
      ...
      creditHours: 3,
      prerequisites: ["Programming II","Introduction to Cybersecurity"],
      materials: {
    ...
    },
    {
      ...
      creditHours: 3,
      prerequisites: ["Software Engineering","Secure Software Development"],
      materials: {
    ...
    },
    {
      ...
      creditHours: 3,
      prerequisites: ["Introduction to Databases","Computer Networks"],
      materials: {
    ...
    },
    {
      ...
      creditHours: 3,
      prerequisites: ["Cloud Computing","Cryptography"],
      materials: {
    ...
    },
    {
      ...
      creditHours: 3,
      prerequisites: ["Field Training I","Linear Algebra","Probability and Statistics II","Social Network Computing"],
      materials: {
  ...
  "media-analytics": [
    ...
    },
    {
      ...
      creditHours: 3,
      prerequisites: ["Digital Video Production","Image Processing"],
      materials: {
    ...
    },
    {
      ...
      creditHours: 3,
      prerequisites: ["Programming II","Computer Graphics"],
      materials: {
  ...
  "healthcare-informatics": [
    ...
    },
    {
      ...
      creditHours: 3,
      prerequisites: ["E-health, Telehealth and Telemedicine","Mathematical Modelling for Health"],
      materials: {
        lectures: "",
        summaries: "",
        sections: "",
